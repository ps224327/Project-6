...
<body class="bg-green-100">
    <div class="relative">
        ...
        <div class="absolute top-0 left-0 flex flex-col justify-center h-full w-full px-8">
            ...
            <a href="{{url('/contact')}}" class="bg-green-700 w-3 hover:bg-green-600 text-white font-bold py-2 px-4 rounded-r-lg border-t border-b border-r border-blue-500 border-gray-200">Contact</a>
        </div>
    </div>
    <div class="absolute top-0 left-0 flex flex-col justify-center h-full w-full px-8 text-center">
        ...
        <form action="#" method="POST" class="mx-auto">
            <div class="flex items-center py-2">
                ...
                <button type="submit" class="bg-green-700 hover:bg-green-600 text-white font-bold py-2 px-4 rounded-r-lg border-t border-b border-r border-blue-500 border-gray-200">Houd mij op de hoogte!</button>
            </div>
        </form>
    </div>
