            ...
            <div>
                <form action="{{ route('products.update', ['product' => $product->id]) }}" method="POST"
                    ...
                    <div class="mb-4">
                        ...
                        class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" value="{{ $product->name }}" required>
                    </div>
                    <div class="mb-4">
                        <label for="barcode" class="font-bold">Barcode:</label>
                        <input type="text" name="barcode" id="barcode"
                        class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" value="{{ $product->barcode }}" required>
                    </div>
                    <div class="mb-4">
                    ...
                    <div class="mb-4">
                        <label for="image" class="font-bold">Afbeelding:</label>
